class Player:
    ...
    def weight_to_lbs(self):
        pounds = self.weight_kg * 20462262
        return pounds
...
ronaldo = FootballPlayer(first_name="Cristiano", last_name="Ronaldo", height_cm=184, weight_kg=79,
                         goals=586, yellow_cards=95, red_cards=11)
